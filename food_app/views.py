...
class AddRecipeView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'food_app/add_recipe.html'
...
class RecipeUpdateView(LoginRequiredMixin, UpdateView):
    model = Recipe
    form_class = RecipeForm
    template_name = 'food_app/update_recipe.html'
    success_url = reverse_lazy('home')
...
class RecipeListView(ListView):
    template_name = 'food_app/home.html'
...
class AddIngredientView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'food_app/add_ingredient.html'


class IngredientListView(ListView):
    model = Ingredient
    context_object_name = 'ingredients'
    template_name = 'food_app/ingredients_list.html'


class IngredientDetailView(DetailView):
    template_name = 'food_app/ingredient_detail.html'
    model = Ingredient
...
class AddCategoryView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'food_app/add_category.html'


class CategoryListView(ListView):
    model = Category
    context_object_name = 'categories'
    template_name = 'food_app/categories_list.html'


class CategoryDetailView(DetailView):
    template_name = 'food_app/category_detail.html'
    model = Category
